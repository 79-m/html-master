...
productList .forEach(function(value,index,array){
  ...
  if(value.isAccessory){
    productBox.innerHTML +=cardlist;
  }
  else{
    clothBox.innerHTML +=cardlist;
  }
})
...
//   p1.innerHTML=value.brand ;
//   cardwrapper.appendChild(p1);
  

//   let p2= document.createElement("p")
//   p2.innerHTML=value.price ;
//   cardwrapper.appendChild(p2);
//   console.log(p2);
...
//   if(value.isAccessory)
//  {
//       productBox.appendChild(cardwrapper)
//   }else{
//      cloth.appendChild(cardwrapper)
//   }
